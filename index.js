...
const app = express()
const { isValidName, isValidEmail, isValidPwd } = require("./validations.js")
...
app.post("/", function (req, res) {
    ...
    if (!isValidEmail(email)) {
        return res.send({ status: false, message: 'Please enter valid e-mail address' })
    }
    ...
    con.query(sql, function (error, result) {
        if (alreadyExist == false) {
            return res.send('Your Account is Created successfully');
        }
    });
});
